...
export function BookCall({ selectedDate, onBookingCreated }) {
  // Modal state
  ...
  const [selectedCallType, setSelectedCallType] = useState('Onboarding');
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-md relative shadow-xl">
            ...
            <div className="flex gap-2 mb-4">
              {[
                { type: "Onboarding", duration: "40min" },
                { type: "Follow-up", duration: "20min" }
              ].map(({ type, duration }) => (
                <button
                  key={type}
